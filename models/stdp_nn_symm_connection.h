...
#ifndef STDP_NN_SYMM_CONNECTION_H
#define STDP_NN_SYMM_CONNECTION_H
...
template < typename targetidentifierT >
inline void
STDPNNSymmConnection< targetidentifierT >::send( Event& e, thread t, const CommonSynapseProperties& )
{
...
template < typename targetidentifierT >
STDPNNSymmConnection< targetidentifierT >::STDPNNSymmConnection()
  : ConnectionBase()
  , weight_( 1.0 )
  , tau_plus_( 20.0 )
  , lambda_( 0.01 )
...
template < typename targetidentifierT >
void
STDPNNSymmConnection< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
...
template < typename targetidentifierT >
void
STDPNNSymmConnection< targetidentifierT >::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
...
#endif // of #ifndef STDP_NN_SYMM_CONNECTION_H
